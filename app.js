...
app.post('/', async (req, res) => {
    ...
    try {
        ...
        const response = await axios.get(`http://api.openweathermap.org/data/2.5/weather?q=${city},${country}&units=metric&appid=942dc843fa4d324454a3bb794446abf8`);
...
app.get('/manchester', async (req, res) => {
    const response = await axios.get('https://api.openweathermap.org/data/2.5/onecall?lat=53.48&lon=2.24&exclude=hourly,current,%20minutely&%20&units=metric&appid=942dc843fa4d324454a3bb794446abf8');
